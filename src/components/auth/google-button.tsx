    ...
    >
      {!loading && (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" aria-hidden>
          <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.76h3.57c2.08-1.92 3.28-4.74 3.28-8.08z" fill="#4285F4" />
          ...
          <path d="M5.84 14.1A6.98 6.98 0 0 1 5.47 12c0-.73.13-1.44.36-2.1V7.07H2.18A10.98 10.98 0 0 0 1 12c0 1.77.43 3.45 1.18 4.93l3.66-2.83z" fill="#FBBC05" />
